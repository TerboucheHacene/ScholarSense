...
It uses a [Sentence Transformer Model](https://www.sbert.net/docs/package_reference/SentenceTransformer.html#)  to calculate the similarity between your query and the papers' abstracts.
